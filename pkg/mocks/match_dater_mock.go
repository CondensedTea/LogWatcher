...
//go:generate minimock -i LogWatcher/pkg/stats.MatchDater -o ./pkg/mocks/match_dater_mock.go
...
type MatchDaterMock struct {
	...
	funcPlayerStatsMap          func() (m1 map[steamid.SID64]*mm_stats.PlayerGameStats)
...
// MatchDaterMockFlushPlayerStatsMapExpectation specifies expectation struct of the MatchDater.FlushPlayerStatsMap
...
// Expect sets up expected params for MatchDater.FlushPlayerStatsMap
func (mmFlushPlayerStatsMap *mMatchDaterMockFlushPlayerStatsMap) Expect() *mMatchDaterMockFlushPlayerStatsMap {
	if mmFlushPlayerStatsMap.mock.funcFlushPlayerStatsMap != nil {
		mmFlushPlayerStatsMap.mock.t.Fatalf("MatchDaterMock.FlushPlayerStatsMap mock is already set by Set")
	}
...
// Inspect accepts an inspector function that has same arguments as the MatchDater.FlushPlayerStatsMap
func (mmFlushPlayerStatsMap *mMatchDaterMockFlushPlayerStatsMap) Inspect(f func()) *mMatchDaterMockFlushPlayerStatsMap {
	if mmFlushPlayerStatsMap.mock.inspectFuncFlushPlayerStatsMap != nil {
		mmFlushPlayerStatsMap.mock.t.Fatalf("Inspect function is already set for MatchDaterMock.FlushPlayerStatsMap")
	}
...
// Return sets up results that will be returned by MatchDater.FlushPlayerStatsMap
...
//Set uses given function f to mock the MatchDater.FlushPlayerStatsMap method
func (mmFlushPlayerStatsMap *mMatchDaterMockFlushPlayerStatsMap) Set(f func()) *MatchDaterMock {
	if mmFlushPlayerStatsMap.defaultExpectation != nil {
		mmFlushPlayerStatsMap.mock.t.Fatalf("Default expectation is already set for the MatchDater.FlushPlayerStatsMap method")
	}

	if len(mmFlushPlayerStatsMap.expectations) > 0 {
		mmFlushPlayerStatsMap.mock.t.Fatalf("Some expectations are already set for the MatchDater.FlushPlayerStatsMap method")
	}
...
func (mmFlushPlayerStatsMap *MatchDaterMock) FlushPlayerStatsMap() {
	...
	mmFlushPlayerStatsMap.t.Fatalf("Unexpected call to MatchDaterMock.FlushPlayerStatsMap.")
...
func (m *MatchDaterMock) MinimockFlushPlayerStatsMapInspect() {
	for _, e := range m.FlushPlayerStatsMapMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Error("Expected call to MatchDaterMock.FlushPlayerStatsMap")
		}
	}
...
// MatchDaterMockPlayerStatsMapExpectation specifies expectation struct of the MatchDater.PlayerStatsMap
...
// MatchDaterMockPlayerStatsMapResults contains results of the MatchDater.PlayerStatsMap
type MatchDaterMockPlayerStatsMapResults struct {
	m1 map[steamid.SID64]*mm_stats.PlayerGameStats
}

// Expect sets up expected params for MatchDater.PlayerStatsMap
func (mmPlayerStatsMap *mMatchDaterMockPlayerStatsMap) Expect() *mMatchDaterMockPlayerStatsMap {
	if mmPlayerStatsMap.mock.funcPlayerStatsMap != nil {
		mmPlayerStatsMap.mock.t.Fatalf("MatchDaterMock.PlayerStatsMap mock is already set by Set")
	}
...
// Inspect accepts an inspector function that has same arguments as the MatchDater.PlayerStatsMap
func (mmPlayerStatsMap *mMatchDaterMockPlayerStatsMap) Inspect(f func()) *mMatchDaterMockPlayerStatsMap {
	if mmPlayerStatsMap.mock.inspectFuncPlayerStatsMap != nil {
		mmPlayerStatsMap.mock.t.Fatalf("Inspect function is already set for MatchDaterMock.PlayerStatsMap")
	}
...
// Return sets up results that will be returned by MatchDater.PlayerStatsMap
func (mmPlayerStatsMap *mMatchDaterMockPlayerStatsMap) Return(m1 map[steamid.SID64]*mm_stats.PlayerGameStats) *MatchDaterMock {
	if mmPlayerStatsMap.mock.funcPlayerStatsMap != nil {
		mmPlayerStatsMap.mock.t.Fatalf("MatchDaterMock.PlayerStatsMap mock is already set by Set")
	}
	...
	mmPlayerStatsMap.defaultExpectation.results = &MatchDaterMockPlayerStatsMapResults{m1}
	return mmPlayerStatsMap.mock
}

//Set uses given function f to mock the MatchDater.PlayerStatsMap method
func (mmPlayerStatsMap *mMatchDaterMockPlayerStatsMap) Set(f func() (m1 map[steamid.SID64]*mm_stats.PlayerGameStats)) *MatchDaterMock {
	if mmPlayerStatsMap.defaultExpectation != nil {
		mmPlayerStatsMap.mock.t.Fatalf("Default expectation is already set for the MatchDater.PlayerStatsMap method")
	}

	if len(mmPlayerStatsMap.expectations) > 0 {
		mmPlayerStatsMap.mock.t.Fatalf("Some expectations are already set for the MatchDater.PlayerStatsMap method")
	}
...
func (mmPlayerStatsMap *MatchDaterMock) PlayerStatsMap() (m1 map[steamid.SID64]*mm_stats.PlayerGameStats) {
	...
	if mmPlayerStatsMap.PlayerStatsMapMock.defaultExpectation != nil {
		...
		if mm_results == nil {
			mmPlayerStatsMap.t.Fatal("No results are set for the MatchDaterMock.PlayerStatsMap")
		}
	...
	mmPlayerStatsMap.t.Fatalf("Unexpected call to MatchDaterMock.PlayerStatsMap.")
	return
}
...
func (m *MatchDaterMock) MinimockPlayerStatsMapInspect() {
	for _, e := range m.PlayerStatsMapMock.expectations {
		if mm_atomic.LoadUint64(&e.Counter) < 1 {
			m.t.Error("Expected call to MatchDaterMock.PlayerStatsMap")
		}
	}
