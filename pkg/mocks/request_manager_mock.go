...
//go:generate minimock -i LogWatcher/pkg/requests.LogProcessor -o ./pkg/mocks/request_manager_mock.go
...
// LogProcessorMock implements requests.LogProcessor
...
// NewLogProcessorMock returns a mock for requests.LogProcessor
...
// LogProcessorMockGetPickupGamesExpectation specifies expectation struct of the LogProcessor.GetPickupGames
...
// LogProcessorMockGetPickupGamesParams contains parameters of the LogProcessor.GetPickupGames
type LogProcessorMockGetPickupGamesParams struct {
	domain string
}

// LogProcessorMockGetPickupGamesResults contains results of the LogProcessor.GetPickupGames
type LogProcessorMockGetPickupGamesResults struct {
	g1  mm_requests.GamesResponse
	err error
}

// Expect sets up expected params for LogProcessor.GetPickupGames
...
// Inspect accepts an inspector function that has same arguments as the LogProcessor.GetPickupGames
...
// Return sets up results that will be returned by LogProcessor.GetPickupGames
...
//Set uses given function f to mock the LogProcessor.GetPickupGames method
func (mmGetPickupGames *mLogProcessorMockGetPickupGames) Set(f func(domain string) (g1 mm_requests.GamesResponse, err error)) *LogProcessorMock {
	if mmGetPickupGames.defaultExpectation != nil {
		mmGetPickupGames.mock.t.Fatalf("Default expectation is already set for the LogProcessor.GetPickupGames method")
	}

	if len(mmGetPickupGames.expectations) > 0 {
		mmGetPickupGames.mock.t.Fatalf("Some expectations are already set for the LogProcessor.GetPickupGames method")
	}
...
// When sets expectation for the LogProcessor.GetPickupGames which will trigger the result defined by the following
// Then helper
...
// Then sets up LogProcessor.GetPickupGames return parameters for the expectation previously defined by the When method
...
// GetPickupGames implements requests.LogProcessor
...
// LogProcessorMockMakeMultipartMapExpectation specifies expectation struct of the LogProcessor.MakeMultipartMap
...
// LogProcessorMockMakeMultipartMapParams contains parameters of the LogProcessor.MakeMultipartMap
...
// LogProcessorMockMakeMultipartMapResults contains results of the LogProcessor.MakeMultipartMap
type LogProcessorMockMakeMultipartMapResults struct {
	m1 map[string]io.Reader
}

// Expect sets up expected params for LogProcessor.MakeMultipartMap
...
// Inspect accepts an inspector function that has same arguments as the LogProcessor.MakeMultipartMap
...
// Return sets up results that will be returned by LogProcessor.MakeMultipartMap
...
//Set uses given function f to mock the LogProcessor.MakeMultipartMap method
func (mmMakeMultipartMap *mLogProcessorMockMakeMultipartMap) Set(f func(_map string, domain string, pickupID int, buf bytes.Buffer) (m1 map[string]io.Reader)) *LogProcessorMock {
	if mmMakeMultipartMap.defaultExpectation != nil {
		mmMakeMultipartMap.mock.t.Fatalf("Default expectation is already set for the LogProcessor.MakeMultipartMap method")
	}

	if len(mmMakeMultipartMap.expectations) > 0 {
		mmMakeMultipartMap.mock.t.Fatalf("Some expectations are already set for the LogProcessor.MakeMultipartMap method")
	}
...
// When sets expectation for the LogProcessor.MakeMultipartMap which will trigger the result defined by the following
// Then helper
...
// Then sets up LogProcessor.MakeMultipartMap return parameters for the expectation previously defined by the When method
...
// MakeMultipartMap implements requests.LogProcessor
...
// LogProcessorMockResolvePlayersExpectation specifies expectation struct of the LogProcessor.ResolvePlayers
...
// LogProcessorMockResolvePlayersParams contains parameters of the LogProcessor.ResolvePlayers
type LogProcessorMockResolvePlayersParams struct {
	domain  string
	players []*stats.PickupPlayer
}

// LogProcessorMockResolvePlayersResults contains results of the LogProcessor.ResolvePlayers
type LogProcessorMockResolvePlayersResults struct {
	err error
}

// Expect sets up expected params for LogProcessor.ResolvePlayers
...
// Inspect accepts an inspector function that has same arguments as the LogProcessor.ResolvePlayers
...
// Return sets up results that will be returned by LogProcessor.ResolvePlayers
...
//Set uses given function f to mock the LogProcessor.ResolvePlayers method
func (mmResolvePlayers *mLogProcessorMockResolvePlayers) Set(f func(domain string, players []*stats.PickupPlayer) (err error)) *LogProcessorMock {
	if mmResolvePlayers.defaultExpectation != nil {
		mmResolvePlayers.mock.t.Fatalf("Default expectation is already set for the LogProcessor.ResolvePlayers method")
	}

	if len(mmResolvePlayers.expectations) > 0 {
		mmResolvePlayers.mock.t.Fatalf("Some expectations are already set for the LogProcessor.ResolvePlayers method")
	}
...
// When sets expectation for the LogProcessor.ResolvePlayers which will trigger the result defined by the following
// Then helper
...
// Then sets up LogProcessor.ResolvePlayers return parameters for the expectation previously defined by the When method
...
// ResolvePlayers implements requests.LogProcessor
...
// LogProcessorMockUploadLogFileExpectation specifies expectation struct of the LogProcessor.UploadLogFile
...
// LogProcessorMockUploadLogFileParams contains parameters of the LogProcessor.UploadLogFile
type LogProcessorMockUploadLogFileParams struct {
	payload map[string]io.Reader
}

// LogProcessorMockUploadLogFileResults contains results of the LogProcessor.UploadLogFile
type LogProcessorMockUploadLogFileResults struct {
	err error
}

// Expect sets up expected params for LogProcessor.UploadLogFile
...
// Inspect accepts an inspector function that has same arguments as the LogProcessor.UploadLogFile
...
// Return sets up results that will be returned by LogProcessor.UploadLogFile
...
//Set uses given function f to mock the LogProcessor.UploadLogFile method
func (mmUploadLogFile *mLogProcessorMockUploadLogFile) Set(f func(payload map[string]io.Reader) (err error)) *LogProcessorMock {
	if mmUploadLogFile.defaultExpectation != nil {
		mmUploadLogFile.mock.t.Fatalf("Default expectation is already set for the LogProcessor.UploadLogFile method")
	}

	if len(mmUploadLogFile.expectations) > 0 {
		mmUploadLogFile.mock.t.Fatalf("Some expectations are already set for the LogProcessor.UploadLogFile method")
	}
...
// When sets expectation for the LogProcessor.UploadLogFile which will trigger the result defined by the following
// Then helper
...
// Then sets up LogProcessor.UploadLogFile return parameters for the expectation previously defined by the When method
...
// UploadLogFile implements requests.LogProcessor
